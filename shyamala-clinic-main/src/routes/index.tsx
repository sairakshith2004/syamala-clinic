...
import baby1 from "@/assets/newborn.jpeg";
    ...
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="relative md:col-span-5">
            ...
            <div className="flex gap-3 mt-4 md:contents">
              ...
              <div className="glass-strong flex-1 md:flex-none md:absolute md:-top-4 md:-right-4 rounded-2xl p-4 text-center md:p-4">
                ...
                <span className="mt-1 inline-block text-lg text-primary" aria-hidden>♥</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-16 md:grid-cols-12">
          ...
          <Reveal className="space-y-6 text-muted-foreground md:col-span-7 md:pt-3" delay={150}>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6">
              <img src={entranceImg} alt="Hospital entrance" className="aspect-[4/3] w-full rounded-2xl object-cover shadow-lg" />
              <img src={lapImg} alt="Laparoscopic surgery in progress" className="aspect-[4/3] w-full rounded-2xl object-cover shadow-lg" />
            </div>
          </Reveal>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24 md:py-32">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
          <Reveal delay={0}><img src={baby1} alt="A family with their newborn" className="aspect-[4/5] w-full rounded-2xl object-cover shadow-xl" /></Reveal>
          <Reveal delay={150}><img src={baby2} alt="Nurse with a newborn" className="aspect-[4/5] w-full rounded-2xl object-cover shadow-xl md:translate-y-12" /></Reveal>
          <Reveal delay={300}><img src={lapImg} alt="Operating theatre" className="aspect-[4/5] w-full rounded-2xl object-cover shadow-xl" /></Reveal>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:py-24">
        <Reveal><div className="glass-teal rounded-3xl px-8 py-12 text-center md:px-16 md:py-16">
